...
- die Sensor-Konfiguration muss angelegt und für den Feinstaubsensor vorbereitet sein (CSV-Datei - siehe Doku dort)
- in der Sensor-Konfiguration befindet sich für jedes Gerät/Sensor/Wert ein Konfigurationssatz, über den u.a. gesteuert werden kann, was mit dem Datensatz geschehen soll - es kann konfiguriert werden ...
  ...
  - über ein Datenbank-Flag kann entschieden werden, ob der Device-Datensatz in der Sensor-Datenbank abgelegt wird
...
- es werden intern unterschiedliche 'payloads' generiert, die für eigene Entwicklungen genutzt werden können:
  ...
  - payload_sql: SQL-Befehle zur Übernahme in die Sensor-Datenbank
